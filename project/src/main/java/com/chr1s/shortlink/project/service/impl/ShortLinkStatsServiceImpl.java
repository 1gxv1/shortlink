...
import com.chr1s.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    private final LinkOStatsMapper linkOsStatsMapper;
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        ...
        List<String> userAccessLogsList = linkAccessLogsDOIPage.getRecords().stream().map(LinkAccessLogsDO::getUser).toList();
        IPage<ShortLinkStatsAccessRecordRespDTO> actualResult = linkAccessLogsDOIPage.convert(each -> BeanUtil.toBean(each, ShortLinkStatsAccessRecordRespDTO.class));


        List<Map<String, Object>> uvTypeList = linkAccessLogsMapper.selectUvTypeByUsers(requestParam.getGid(),
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        List<LinkAccessStatsDO> listStatsByGroup = linkAccessStatsMapper.linkStatsByGroup(requestParam);
