...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    void shortLinkStats(@Param("linkAccessStats") LinkAccessStatsDO linkAccessStatsDTO);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "     gid, date;")
    List<LinkAccessStatsDO> linkStatsByGroup(@Param("param") ShortLinkGroupStatsReqDTO requestParam);
